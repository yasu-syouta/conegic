...
namespace level
{
	class VSGame : public ILevel
	{
		...
		std::shared_ptr<draw::draw_game> draw_[2];
		std::shared_ptr<Status> status[2];
		std::shared_ptr<GameObject::field> field_[2];
		std::shared_ptr<GameObject::cursor> cursor_[2];
